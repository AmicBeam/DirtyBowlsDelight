...
一个 Minecraft Forge mod，让所有碗装食物（包括原版和 FarmersDelight 的汤类食物）在食用后返回脏碗而不是普通碗。

## 功能

- ✅ **原版汤类食物**：蘑菇汤、甜菜汤等食用后返回脏碗
- ✅ **FarmersDelight 汤类食物**：所有 FD 的汤类食物（如牛肉汤、鸡汤等）食用后返回脏碗
- ✅ **单堆叠支持**：单个汤食用后返回脏碗
...
- **Minecraft**: 1.20.1
- **Forge**: 47.0.0 或更高版本
- **Artisanal Mod**: 1.7.0 或更高版本（提供脏碗物品）
